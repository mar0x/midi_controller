...
namespace port {
    ...
    struct traits {
#if !defined(ARDUINO_ARCH_AVR)
        static void dirset(uint8_t mask) { (void) mask; }
        static void dirclr(uint8_t mask) { (void) mask; }
        static void dirtgl(uint8_t mask) { (void) mask; }
        static uint8_t in() { return 0; }
        static void outset(uint8_t mask) { (void) mask; }
        static void outclr(uint8_t mask) { (void) mask; }
        static void outtgl(uint8_t mask) { (void) mask; }
#endif
    };
    ...
    struct traits<F> {
        ...
        constexpr static uint8_t adc_channel(uint8_t pin) { return pin; }
    };
    ...
    template<>
    struct traits<DUMMY_HIGH> {
        static void dirset(uint8_t mask) { (void) mask; }
        static void dirclr(uint8_t mask) { (void) mask; }
        static void dirtgl(uint8_t mask) { (void) mask; }
        static uint8_t in() { return 0xFFu; }
        static void outset(uint8_t mask) { (void) mask; }
        static void outclr(uint8_t mask) { (void) mask; }
        static void outtgl(uint8_t mask) { (void) mask; }
    };
    ...
    struct reg_traits {
        ...
        static void dirclr(uint8_t mask) { (void) mask; }
        static void dirtgl(uint8_t mask) { (void) mask; }
        static uint8_t in() { return reg; }
        static volatile uint8_t& out() { return reg; }
        static void outset(uint8_t mask) { out() |= mask; }
        static void outclr(uint8_t mask) { out() &= ~mask; }
        static void outtgl(uint8_t mask) { out() ^= mask; }
    };
